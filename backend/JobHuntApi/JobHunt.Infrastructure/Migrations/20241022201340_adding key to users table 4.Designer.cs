...
namespace JobHunt.Infrastructure.Migrations
{
    ...
    [Migration("20241022201340_adding key to users table 4")]
    partial class addingkeytouserstable4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3159f6f0-224d-4f8c-983c-8e748e628448"),
                            CompanyName = "CompanyName",
                            Location = "Location",
                            Position = "Position",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8440),
                            WorkTo = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8441)
                        },
                        new
                        {
                            Id = new Guid("737699a6-e9ae-4413-a920-8fecc0c64ae2"),
                            CompanyName = "CompanyName 2",
                            Location = "Location 2",
                            Position = "Position 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 2",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8445),
                            WorkTo = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8446)
                        },
                        new
                        {
                            Id = new Guid("27d0d36a-5dd8-46b0-a9ce-8bab3bf7df74"),
                            CompanyName = "CompanyName 3",
                            Location = "Location 3",
                            Position = "Position 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 3",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8460),
                            WorkTo = new DateTime(2024, 10, 22, 20, 13, 40, 281, DateTimeKind.Utc).AddTicks(8461)
                        });
                });
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "avatar.jpg",
                            DateOfBirth = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(5303),
                            Email = "john@doe.com",
                            Lastname = "Doe",
                            Name = "John ",
                            Phone = "123456789"
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.University", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea733b5f-b93a-48f6-b4a2-5235ae28ffdd"),
                            EducationLevel = "Bachelor",
                            FieldOfStudy = "Field of Study",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7379),
                            StudyTo = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7380),
                            UniversityName = "Vistula"
                        },
                        new
                        {
                            Id = new Guid("771853d5-050a-450f-ae63-13b5be95d4aa"),
                            EducationLevel = "Bachelor 2",
                            FieldOfStudy = "Field of Study 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 2",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7385),
                            StudyTo = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7385),
                            UniversityName = "Vistula 2"
                        },
                        new
                        {
                            Id = new Guid("3f5bb1d5-f920-495d-9393-5da3d80fce39"),
                            EducationLevel = "Bachelor 3",
                            FieldOfStudy = "Field of Study 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 3",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7388),
                            StudyTo = new DateTime(2024, 10, 22, 20, 13, 40, 282, DateTimeKind.Utc).AddTicks(7388),
