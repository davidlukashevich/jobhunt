...
namespace JobHunt.Infrastructure.Migrations
{
    ...
    [Migration("20241022090756_adding key to users table")]
    partial class addingkeytouserstable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d4031e87-5fb1-4e0a-9c5d-5863b5eb8259"),
                            CompanyName = "CompanyName",
                            Location = "Location",
                            Position = "Position",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility",
                            WorkFrom = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2924),
                            WorkTo = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2926)
                        },
                        new
                        {
                            Id = new Guid("72ac3901-4b6d-43d7-af31-8b4216d4d6ad"),
                            CompanyName = "CompanyName 2",
                            Location = "Location 2",
                            Position = "Position 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 2",
                            WorkFrom = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2933),
                            WorkTo = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2934)
                        },
                        new
                        {
                            Id = new Guid("3734be0d-e047-46db-93a3-3a4f312277a2"),
                            CompanyName = "CompanyName 3",
                            Location = "Location 3",
                            Position = "Position 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 3",
                            WorkFrom = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2953),
                            WorkTo = new DateTime(2024, 10, 22, 9, 7, 56, 262, DateTimeKind.Utc).AddTicks(2954)
                        });
                });
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "avatar.jpg",
                            DateOfBirth = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(2131),
                            Email = "john@doe.com",
                            Lastname = "Doe",
                            Name = "John ",
                            Phone = "123456789"
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.University", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f6963469-f574-40bf-9058-40f92bc91d2c"),
                            EducationLevel = "Bachelor",
                            FieldOfStudy = "Field of Study",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science",
                            StudyFrom = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(4988),
                            StudyTo = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(4990),
                            UniversityName = "Vistula"
                        },
                        new
                        {
                            Id = new Guid("83e8dba7-1592-4d73-827c-5b0179ddd3d6"),
                            EducationLevel = "Bachelor 2",
                            FieldOfStudy = "Field of Study 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 2",
                            StudyFrom = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(4996),
                            StudyTo = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(4996),
                            UniversityName = "Vistula 2"
                        },
                        new
                        {
                            Id = new Guid("9f7320a0-91cf-4b8b-8d8c-1fb49def3a3a"),
                            EducationLevel = "Bachelor 3",
                            FieldOfStudy = "Field of Study 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 3",
                            StudyFrom = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(5001),
                            StudyTo = new DateTime(2024, 10, 22, 9, 7, 56, 263, DateTimeKind.Utc).AddTicks(5002),
