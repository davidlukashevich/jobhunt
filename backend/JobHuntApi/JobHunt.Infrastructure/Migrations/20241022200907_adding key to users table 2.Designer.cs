...
namespace JobHunt.Infrastructure.Migrations
{
    ...
    [Migration("20241022200907_adding key to users table 2")]
    partial class addingkeytouserstable2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("30b27bf4-a5d3-4d7c-8798-895a6f01038c"),
                            CompanyName = "CompanyName",
                            Location = "Location",
                            Position = "Position",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(316),
                            WorkTo = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(318)
                        },
                        new
                        {
                            Id = new Guid("26ae5e69-5534-460d-8bc0-1c6cd358095e"),
                            CompanyName = "CompanyName 2",
                            Location = "Location 2",
                            Position = "Position 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 2",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(325),
                            WorkTo = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(326)
                        },
                        new
                        {
                            Id = new Guid("fe0fb5ab-e04c-43aa-90bd-d7cc7417c2a8"),
                            CompanyName = "CompanyName 3",
                            Location = "Location 3",
                            Position = "Position 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Responsibility = "Responsibility 3",
                            WorkFrom = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(329),
                            WorkTo = new DateTime(2024, 10, 22, 20, 9, 7, 198, DateTimeKind.Utc).AddTicks(330)
                        });
                });
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "avatar.jpg",
                            DateOfBirth = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(402),
                            Email = "john@doe.com",
                            Lastname = "Doe",
                            Name = "John ",
                            Phone = "123456789"
            ...
            modelBuilder.Entity("JobHunt.Domain.Models.University", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4d36cf86-e9fb-4f02-9704-a33f174af52b"),
                            EducationLevel = "Bachelor",
                            FieldOfStudy = "Field of Study",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3447),
                            StudyTo = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3448),
                            UniversityName = "Vistula"
                        },
                        new
                        {
                            Id = new Guid("df716e47-8642-49a4-b567-63cb301dc92e"),
                            EducationLevel = "Bachelor 2",
                            FieldOfStudy = "Field of Study 2",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 2",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3454),
                            StudyTo = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3455),
                            UniversityName = "Vistula 2"
                        },
                        new
                        {
                            Id = new Guid("95f0c796-0eb6-4525-aaae-ab9712fd3901"),
                            EducationLevel = "Bachelor 3",
                            FieldOfStudy = "Field of Study 3",
                            ProfileId = new Guid("a51bd4f1-8501-405e-a634-bdb1d8bd8511"),
                            Specialization = "Computer Science 3",
                            StudyFrom = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3458),
                            StudyTo = new DateTime(2024, 10, 22, 20, 9, 7, 199, DateTimeKind.Utc).AddTicks(3459),
